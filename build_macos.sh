#!/usr/bin/env bash
# =============================================================================
# build_macos.sh — Build single-file Migration Insights executables for macOS
#
...
#
# Output (examples):
#   dist/migration-insights-0.8.2.8-macos-arm64
#   dist/migration-insights-0.8.2.8-macos-x86_64
# =============================================================================
set -euo pipefail
...
echo "==> Building Migration Insights v${APP_VERSION} for macOS"
...
build_one() {
    ...
    dist_name="migration-insights-${APP_VERSION}-macos-${target_arch}"
...
echo "  ./dist/migration-insights-${APP_VERSION}-macos-arm64      # Apple Silicon"
echo "  ./dist/migration-insights-${APP_VERSION}-macos-x86_64   # Intel"
echo ""
echo "  MI_HOST=127.0.0.1 MI_PORT=3030 ./dist/migration-insights-..."
