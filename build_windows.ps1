# =============================================================================
# build_windows.ps1 — Build single-file Migration Insights executables for Windows
#
...
#
# Output (examples):
#   dist\migration-insights-0.8.2.8-windows-x86_64.exe
#   dist\migration-insights-0.8.2.8-windows-arm64.exe
# =============================================================================
...
function Build-One {
    ...
    $distExe = Join-Path "dist" "migration-insights.exe"
    ...
    if (-not (Test-Path $distExe)) {
        throw "PyInstaller did not produce dist\migration-insights.exe"
    }

    Remove-Item -Recurse -Force $venvDir -ErrorAction SilentlyContinue

    $appVersion = Get-AppVersion
    $distName = "migration-insights-$appVersion-windows-$TargetArch.exe"
...
$appVersion = Get-AppVersion
Write-Host "==> Building Migration Insights v$appVersion for Windows"
...
Write-Host "  .\dist\migration-insights-$appVersion-windows-x86_64.exe   # most PCs (Intel/AMD 64-bit)"
Write-Host "  .\dist\migration-insights-$appVersion-windows-arm64.exe    # Windows on ARM"
Write-Host ""
Write-Host '  $env:MI_HOST="127.0.0.1"; $env:MI_PORT="3030"; .\dist\migration-insights-...exe'
